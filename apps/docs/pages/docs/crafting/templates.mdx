...
// Example: A basic brail template with meta and props schemas defined.
export default b.template
	.meta(/docs/** (Optional) Define metadata schema e.g { to: string, subject: string} */)
	.props(/docs/** (Optional) Define props schema */)
	.preview(/docs/** Define data for template preview */)
	.view(props => {
