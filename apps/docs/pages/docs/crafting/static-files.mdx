...
Once deployed, these images will be publicly visible. For tips on viewing images while sending test emails, view the [testing emails](/docs/recipes/test-emails) guide