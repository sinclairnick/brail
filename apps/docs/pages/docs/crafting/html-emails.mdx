...
> 🚨 This article provides background info about HTML email and is not necessary to use Brail.

> Feel free to [skip this read](/docs/crafting/templates), if you're just looking to get started.
