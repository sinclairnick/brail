...
// @ts-expect-error ts-migrate(7023) FIXME: 'resolveComponentPath' implicitly has return type ... Remove this comment to see the full error message
export function resolveComponentPath(compPath: any, componentRootPath: any) {
  if (!compPath) {
    return null
  }
